...
pub fn doAppCheck(game: type) void {
        ...
        !@hasDecl(game, "quit"))
    {
        @compileError(
            ...
            \\    pub fn init(ctx: uph.Context) !void
            \\    pub fn event(ctx: uph.Context, e: sdl.Event) !void
            \\    pub fn update(ctx: uph.Context) !void
            \\    pub fn draw(ctx: uph.Context) !void
            \\    pub fn quit(ctx: uph.Context) void
        );
    }
