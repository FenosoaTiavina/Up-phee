...
export fn init(ctx: *const uph.Context.Context, name: [*:0]const u8) bool {
...
export fn deinit(ctx: *const uph.Context.Context, name: [*:0]const u8) void {
    plugin.quit(ctx.*);
    log.info("Plugin({s}) destroyed", .{name});
}

export fn event(ctx: *const uph.Context.Context, e: *const uph.Input.Event, name: [*:0]const u8) void {
...
export fn update(ctx: *const uph.Context.Context, name: [*:0]const u8) void {
...
export fn draw(ctx: *const uph.Context.Context, name: [*:0]const u8) void {
